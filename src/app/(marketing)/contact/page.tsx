    ...
    <div className="pb-20 sm:pb-28 bg-white min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, #0F172A 0%, #1a2d6b 50%, #0F172A 100%)",
          }}
        >
          <div
          ...
          <div className="text-center max-w-4xl mx-auto relative z-10">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white tracking-tight leading-[1.08] mb-5 sm:mb-6">
              ...
              <span
                ...
                style={{
                  backgroundImage: "linear-gradient(90deg, #60a5fa, #F97316)",
                }}
              >
                Great
              </span>{" "}
            ...
            <p className="text-lg sm:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
              ...
              24 hours. No pressure, no jargon, just pure strategy tailored for
              your SMB.
            </p>
          </div>
          <div
