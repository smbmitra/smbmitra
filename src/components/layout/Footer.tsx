...
export default function Footer() {
    ...
    return (
        <footer
            ...
            style={{ background: "linear-gradient(180deg, #0F172A 0%, #080f1d 100%)" }}
        >
            {/* Top gradient divider */}
            <div
                className="absolute top-0 left-0 w-full h-px"
                style={{ background: "linear-gradient(90deg, transparent, rgba(30,64,175,0.5), rgba(249,115,22,0.4), transparent)" }}
                aria-hidden="true"
            />
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 text-sm">
                                ...
                                >
                                    <MapPin className="shrink-0" size={14} style={{ color: "#F97316" }} aria-hidden="true" />
                                </div>
                                <span className="text-slate-400 text-sm">Jangaon, Telangana, India.</span>
                            </li>
                            <li className="flex items-center gap-3 text-sm">
                                ...
                                >
                                    <Mail className="shrink-0" size={14} style={{ color: "#60a5fa" }} aria-hidden="true" />
                                </div>
                                <a
                        ...
                        >
                            ...
                            <p className="text-xs text-slate-400 mt-1">Sat: 10:00 AM – 2:00 PM</p>
                        </div>
                    </div>
                </div>
